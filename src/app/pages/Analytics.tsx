  ...
  return (
    <div className="space-y-12">
      <section className="space-y-2 pt-4">
        <h1 className="text-[2.75rem] font-black leading-none tracking-tighter text-white">HISTORICAL<br />ANALYTICS</h1>
      ...
      <section className="p-6 rounded-lg space-y-8" style={{ backgroundColor: '#121212' }}>
        ...
        <div className="h-64 relative flex items-end justify-between gap-2 overflow-hidden">
          ...
          <div className="w-full h-full flex items-end gap-2 px-2 relative z-10">
            {weekBars.map((h, i) => (
              <div key={i} className="flex-1 rounded-t-sm relative" style={{ height: `${h}%`, backgroundColor: i === 3 ? '#ffffff' : '#353535', boxShadow: i === 3 ? '0 0 20px rgba(255,255,255,0.2)' : 'none' }}>
                {i === 3 && (
                  <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-[10px] font-black text-white px-2 py-1 rounded whitespace-nowrap" style={{ backgroundColor: '#353535' }}>2.4k</div>
                )}
              </div>
            ))}
          </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="rounded-lg p-6 flex flex-col justify-between h-40" style={{ backgroundColor: '#121212' }}>
          <div>
            ...
            <div className="text-4xl font-black text-white mt-2">142 <span className="text-sm font-light" style={{ color: '#c6c6c6' }}>BPM</span></div>
          </div>
        ...
        <div className="rounded-lg p-6 flex flex-col justify-between h-40" style={{ backgroundColor: '#121212', borderLeft: '2px solid #ffffff' }}>
          <div>
            ...
            <div className="text-4xl font-black text-white mt-2">18.2 <span className="text-sm font-light" style={{ color: '#c6c6c6' }}>KM</span></div>
          </div>
      ...
      <section className="rounded-lg p-8 relative overflow-hidden" style={{ backgroundColor: '#121212' }}>
        <div className="relative z-10 flex flex-col items-center gap-8">
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#c6c6c6' }}>Based on your intensity profile and sleep telemetry, we recommend 14 hours of zone 1 activity before next maximal effort.</p>
          </div>
        ...
        <div className="absolute -bottom-10 -right-10 text-[12rem] font-black select-none pointer-events-none" style={{ color: 'rgba(255,255,255,0.03)' }}>DATA+</div>
      </section>
    </div>
  );
};
