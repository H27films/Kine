  ...
  return (
    <div>
      ...
      <section className="mb-20">
        ...
        <h3 style={{ fontSize: '1.2rem', fontWeight: 900, letterSpacing: '0.15em', color: '#ffffff', lineHeight: 1, marginBottom: 8 }}>30 DAYS</h3>
        ...
        <div className="p-6 rounded-xl relative overflow-hidden" style={{ backgroundColor: '#121212' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 14 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginLeft: -8 }}>
              <span style={{ fontSize: '2rem', fontWeight: 900, letterSpacing: '-0.05em', color: '#ffffff', lineHeight: 1 }}>{total30}</span>
