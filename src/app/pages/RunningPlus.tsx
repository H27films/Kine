...
import { Home, ChevronDown, ChevronLeft, ChevronRight, Menu, BarChart3 } from 'lucide-react';
...
const RunningManIcon = ({ size = 24, color = "#1a1a1a" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M9.8 7.6C7.6 7.6 6 9.2 6 11.4c0 1.2.4 2.4 1.2 3.4 1.2-2.5 4.2-4.2 7.2-4.2 1.5 0 3 .3 4.3.9-.7.3-1.5.5-2.3.5-3.9 0-7-3.1-7-7s3.1-7 7-7 7 3.1 7 7c0 1.8-.8 3.4-2.1 4.5V6.5c0-.6.4-1 1-.8.6.2 2.1.7 2.1 2.4h-3.3c-.1.4-.2.7-.2 1.2s0 .8.2 1.2H18c1.2 0 2.7-.4 3.7-1.6.4.1.8.2 1.2.2 1.9 0 3.5-1 4.2-2.5.1.4.1.9-.1 1.3 1.2 1.5 3.9 2.2 4.6 3.6.7.9.8 2.1.3 3.2-.6 1.3-2 2.2-3.8 2.2-.9 0-1.8-.3-2.5-.9-.7.6-1.6.9-2.5.9-1.8 0-3.2-1-3.8-2.2-.4-1.1-.4-2.3.3-3.2.7-1.4 3.4-2.1 4.6-3.6-.1-.4-.2-.9-.1-1.3.7 1.5 2.3 2.5 4.2 2.5 1.9 0 3.4-1 3.4-2.2 0-.6-.4-1-1-.8l-3.2 3.7c-.5.6-1.2.9-2 .9-1.4 0-2.5-.6-3.2-1.6-.2.7-.6 1.3-1.1 1.9z" fill={color}/>
  </svg>
);
