              ...
              {data.map((d, i) => {
                ...
                return (
                  <g key={d.workoutId}>
                    {/* Background bar */}
                    <path
                      d={`M ${x},${bgY + maxBarHeight} L ${x},${bgY + 5} A 5 5 0 0 1 ${x + barWidth},${bgY + 5} L ${x + barWidth},${bgY + maxBarHeight} Z`}
                      fill="rgba(0,0,0,0.02)"
                    />
                    {/* Foreground bar */}
                    <path
                      d={`M ${x},${y + barHeight} L ${x},${y + 5} A 5 5 0 0 1 ${x + barWidth},${y + 5} L ${x + barWidth},${y + barHeight} Z`}
                      fill="#1a1a1a"
                      fillOpacity={opacity}
