    ...
    >
      {day.totalScore > 0 && (
        <div style={{
          ...
          <span style={{ fontSize: '12px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '1.5px', color: 'rgba(26,26,26,0.7)', marginRight: '2px' }}>SCORE</span> <span style={{ fontWeight: 800 }}>{day.totalScore}</span>
        </div>
      )}
