              ...
              {(() => {
                ...
                return maxSpeed > 0 ? (
                  <div style={{ marginTop: '8px' }}>
                    ...
                    <div style={{ fontSize: '24px', fontWeight: 900, letterSpacing: '-0.03em', color: '#1a1a1a', lineHeight: 1.1 }}>
                      {maxSpeed.toFixed(1)}<span style={{ fontSize: '16px', fontWeight: 200, color: '#999', marginLeft: '-4px' }}>KM/H</span>
                    </div>
                  </div>
                ) : null;
              })()}
              ...
              {(() => {
                ...
                return avgSpeed > 0 ? (
                  <div style={{ marginTop: '8px', textAlign: 'right' }}>
                    ...
                    <div style={{ fontSize: '24px', fontWeight: 900, letterSpacing: '-0.03em', color: '#1a1a1a', lineHeight: 1.1 }}>
                      {avgSpeed.toFixed(1)}<span style={{ fontSize: '16px', fontWeight: 200, color: '#999', marginLeft: '-4px' }}>KM/H</span>
                    </div>
                  </div>
                ) : null;
              })()}
