   ...
   useEffect(() => {
     ...
     const { data } = await supabase
       ...
       if (data) {
         ...
         // Calculate minMonthOffset (negative number of months from current)
         const now = new Date();
                 ...
                 <div style={{ flex: 1, textAlign: 'center' }}>
                   ...
                   <div style={{ fontSize: '20px', fontWeight: 900, letterSpacing: '-0.03em', color: '#1a1a1a', lineHeight: 1.1 }}>
                     {(() => {
                       ...
                       return avgSpeed > 0 ? avgSpeed.toFixed(1) : '—';
                     })()}<span style={{ fontSize: '14px', fontWeight: 200, color: '#999', marginLeft: '2px' }}>KM/H</span>
                   </div>
                 </div>
              ...
              <div style={{ marginTop: '20px' }}>
                ...
                >
                  <div style={{
                    ...
                    {/* Tab 1: PROGRESS CHART — click anywhere on it to switch to Weekly Rank */}
                    <div
                    ...
                    {/* Tab 2: WEEKLY RANK — click anywhere on it to switch back to Progress Chart */}
                    <div
                      style={{ width: '50%', cursor: 'pointer' }}
