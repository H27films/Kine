          ...
          return (
            <div key={group}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '0.6rem', paddingLeft: '2px', paddingRight: '2px' }}>
                <div>
                  <span style={{ color: '#1a1a1a', fontWeight: 500, fontSize: '1rem', letterSpacing: '0.02em', display: 'block', fontFamily: "'Archivo', sans-serif", textTransform: 'uppercase' }}>{group}</span>
